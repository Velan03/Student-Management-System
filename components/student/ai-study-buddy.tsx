...
import { Bot, Camera, Lightbulb, Mic, Send, Sparkles, Volume2 } from "lucide-react"
...
export function AIStudyBuddy() {
  ...
  const toggleCapture = () => {
    if (isCapturing) {
      ...
      toast({
        title: "Image capture cancelled",
        description: "Photo capture cancelled",
        variant: "default",
      })
    } else {
      setIsCapturing(true)
      toast({
        ...
        description: "Point your camera at a homework problem to get help",
        variant: "default",
      })

      // Simulate capturing and processing an image
      setTimeout(() => {
        setIsCapturing(false)
        toast({
          title: "Problem captured!",
          description: "Processing your math problem...",
          variant: "default",
        })

        // Simulate AI response to the captured problem
        setTimeout(() => {
          setMessages((prev) => [
            ...prev,
            {
              role: "user",
              content: "I need help with this quadratic equation: x² + 5x + 6 = 0",
            },
            {
              role: "assistant",
              content: `I'll solve this quadratic equation: x² + 5x + 6 = 0

Step 1: Identify the standard form ax² + bx + c = 0
a = 1, b = 5, c = 6
          ...
          <CardFooter className="border-t p-3">
            <div className="flex w-full items-center gap-2">
              ...
              <Button
                ...
                size="icon"
                className={`h-9 w-9 shrink-0 ${isCapturing ? "animate-pulse" : ""}`}
